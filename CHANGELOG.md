...
| 커밋 | 변경 내용 |
|---|---|
| (pending) | metavv: TRY IT · IMAGE CUSTOM UI 재설계 — 실제 제품 스크린샷 기반 |
...
| `7039350` | metavv: STRATEGY 결론 박스 → Before/After 결론 박스로 강화 |
| `937d741` | metavv: AXIS 카드 bullet → exec-step 태그로 변경 |
| `7849dfb` | metavv: Tab1 STRATEGY 시각 강화 (AXIS 카드 메인 수치 추가) |
| `566e524` | metavv: EXECUTION 3단계 시각 위계 강화 |
| `be70f45` | metavv: CONTEXT 다이어그램 SVG→HTML/CSS 전환 |
| `be89150` | revert: CONTEXT ctx-grid 원상복구 |
| `7142ed6` | metavv: PHASE 카드 화살표/구분선 개선 |
| `3e31cab` | metavv: IMPACT 카드 토글 제거 + PROBLEM 도넛 차트 교체 |
| `16a4572` | metavv: EXECUTION Phase 카드 펼침 인터랙션 개선 |
